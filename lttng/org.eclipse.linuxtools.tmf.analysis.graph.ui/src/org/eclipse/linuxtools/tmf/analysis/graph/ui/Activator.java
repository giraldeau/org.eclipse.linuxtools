package org.eclipse.linuxtools.tmf.analysis.graph.ui;
...
public class Activator extends AbstractUIPlugin {
	...
	/** The plug-in ID */
	public static final String PLUGIN_ID = "org.eclipse.linuxtools.tmf.analysis.graph.ui"; //$NON-NLS-1$
    ...
    public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		TmfAnalysisManager.registerParameterProvider(CriticalPathModule.ANALYSIS_ID, CriticalPathAlgorithmProvider.class);
	}
